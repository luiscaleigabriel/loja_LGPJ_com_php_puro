    ...
    <table class="table">
            ...
            <tbody>
                <?php foreach($products as $product): ?>
                    <tr class="<?= $product->quantity < 5 ? 'danger' : '' ?>">
                        <td><?= $product->id ?></td>
                        ...
                        <td> 
                            <?= $product->status === true ? '<svg class="text-success-500 h-6 w-6 text-success" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                        ...
                        <td>
                            <a href="/updateproduct?id=<?= $product->id ?>" class="info-svg">
                            <svg class="filament-link-icon w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path>
                            </svg>
                            </a>
                            <a href="/deleteproduct?id=<?= $product->id ?>" class="text-danger w-4 h-4 mr-1">
