...
<div class="dash--title">
    <h2 class="dash__title">Categorias (<?= $instances['categories']::count() ?>)</h2>
            ...
            <tbody>
                <?php foreach($categories as $category): ?>
                    <tr>
                        ...
                        <td><?= $category->name ?></td>
                        <td><?= $category->slug ?></td>
                        <td><?= $category->status == 1 ? '<svg class="text-success-500 h-6 w-6 text-success" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                    ...
                    <td>
                        <a href="/updatecategory?id=<?= $category->id ?>" class="info-svg">
                            <svg class="filament-link-icon w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path>
                            </svg>
                        </a>
                        <a href="/deletecategory?id=<?= $category->id ?>" class="text-danger w-4 h-4 mr-1">
